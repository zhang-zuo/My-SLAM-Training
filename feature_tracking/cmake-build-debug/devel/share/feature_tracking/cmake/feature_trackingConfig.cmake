...
if("TRUE" STREQUAL "TRUE")
  set(feature_tracking_SOURCE_PREFIX /home/zhangzuo/vo_learn/my_slam-master/src/feature_tracking)
  set(feature_tracking_DEVEL_PREFIX /home/zhangzuo/vo_learn/my_slam-master/src/feature_tracking/cmake-build-debug/devel)
...
if(NOT "/home/zhangzuo/vo_learn/my_slam-master/src/feature_tracking/cmake-build-debug/devel/include " STREQUAL " ")
  set(feature_tracking_INCLUDE_DIRS "")
  set(_include_dirs "/home/zhangzuo/vo_learn/my_slam-master/src/feature_tracking/cmake-build-debug/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'feature_tracking' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhangzuo/vo_learn/my_slam-master/src/feature_tracking/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zhangzuo/vo_learn/my_slam-master/src/feature_tracking/cmake-build-debug/devel/lib;/opt/ros/melodic/lib)
